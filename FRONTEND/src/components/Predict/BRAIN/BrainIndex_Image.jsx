        ...
        <div className='flex justify-center items-start gap-10'>
          ...
          <div className="w-1/4 p-6 bg-white rounded-lg shadow-lg">
              ...
              <div className="flex justify-center space-x-4">
                ...
                {/* <button onClick={handleCancel} className="w-full py-3 mt-6 font-medium tracking-widest text-white uppercase bg-red-500 shadow-lg focus:outline-none hover:bg-red-600 hover:shadow-none rounded-full">
                  Cancel
                </button> */}
              ...
              <div className="w-2/3 px-10">
                  {predictionResult && (
                      <div className="p-4 bg-purple-50 rounded-lg shadow-lg">
                          <p className="text-black font-semibold text-2xl">{predictionResult}</p>
                      </div>
                  )}
              </div>
            </div>
