    ...
    <div className="flex items-center px-20 py-12">
        ...
        <div className="max-w-[500px] mr-8">
            <div className="relative">
                <img
                src="/assets/images/Predict/brain_tumour.jpg"
                alt=""
      ...
      {/* Text on the right */}
      <div className="max-w">
        <h2 className="text-2xl font-bold mb-4">Predict Diseases Based On Analysis Of Brain Images</h2>
        <p className="text-gray-700">
            Welcome to our cutting-edge platform dedicated to revolutionizing healthcare through advanced machine learning. Our state-of-the-art model leverages the power of artificial intelligence to predict diseases based on intricate analysis of brain images. Powered by deep learning algorithms, our system goes beyond traditional diagnostic methods, offering unparalleled accuracy and efficiency in identifying neurological conditions. From early detection of disorders to personalized treatment recommendations, our platform is designed to assist healthcare professionals in making informed decisions, ultimately leading to better patient outcomes. Our commitment to innovation and excellence in healthcare drives us to continuously refine and enhance our model, ensuring it stays at the forefront of medical technology. Join us on the frontier of medical advancements as we strive to make a meaningful impact on the lives of individuals through the fusion of technology and healthcare expertise.
        </p>
